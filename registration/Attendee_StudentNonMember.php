...
$article_three = "";
$article_three_title = "";
$extra_one = "Attendee_StudentNonMember";
$extra_two = "";
$extra_three = "";
$extra_four = "";
$extra_five = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if (empty($_POST["str_degree"]))
     $errorMessage = "10";
   else
     $degree= test_input($_POST["str_degree"]);
     
   if (empty($_POST["str_student_number"]))
     $errorMessage = "11";
   else
     $student_number = test_input($_POST["str_student_number"]);
   ...
   $article_three = test_input($_POST["str_article_three"]);
    ...
    $extra_five =   "S18" . round(10*microtime(true)) . "ASNM";
...
#        $lastInsertedID = mysqli_insert_id($conn);
        ...
        $conn->query("update " . $tableName . " set easypay_ref='$payment[id]' where extra_five='$extra_five'");
...
function sendEmail($uniqueKey, $value,$url)
{
 ...
 # $myemail = 'bruno@codepixel.pt';//<-----Put Your email address here.
  ...
  $email_alt_body = "Dear $name, \n \n" .
					...
					"Registration Type: Student Non-Member \n \n" .
                              ...
                              <span class="card-title cinza-text"><h2>Registration Info</h2></span>
	                              ...
	                              <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
		                                 ...
		                                 <tbody>
		                                   ...
		                                   <tr>
		                                     <td>Degree<span class="error"> * </td>
		                                     <td class="center">
		                                     	<input name="str_degree" type="text" class="validate" required>
		                                     </td>
		                                   </tr>
		                                   
		                                   <tr>
		                                     <td>Student Number<span class="error"> * </td>
		                                     <td class="center">
		                                     	<input name="str_student_number" type="text" class="validate" required>
		                                     </td>
		                                   </tr>
		                                   ...
		                                   <tr>
		                                     <td> 
		                                     	  ...
		                                     	  <button class="btn btn_callToAction waves-effect waves-light" id="next_btn" onclick="funcProcess()" type="submit" name="action">Next
...
<script>
	...
	<script>
		...
		function funcProcess() {
			...
			var gender;      
			if (document.getElementById('str_male').checked)
				gender = "male";
			else if (document.getElementById('str_female').checked) 
				gender = "female";
			else
				gender = "NULL";

			var email = document.getElementById("str_email").value;
			var phone = document.getElementById("str_phone").value;
			var personal_id = document.getElementById("str_personal_id").value;
			var address = document.getElementById("str_address").value;
			var city = document.getElementById("str_city").value;
			var zipcode = document.getElementById("str_zipcode").value;
			var country = document.getElementById("str_country").value;													
			var vatnumber = document.getElementById("str_vatnumber").value;
			<!--var ieeenumber = document.getElementById("str_ieeenumber").value;-->
			
			<!--var pay_status = "NULL";-->
			var pay_value = 500;
						
			<!--var university = document.getElementById("str_university").value;-->
			<!--var degree = document.getElementById("str_degree").value;-->
			<!--var student_number = document.getElementById("str_student_number").value;-->
			var institution = document.getElementById("str_institution").value;
			
			var date_time = new Date();
						
			var e = document.getElementById("article_one");
			var article_one_title = e.options[e.selectedIndex].innerHTML;
			var e = document.getElementById("article_two");
			var article_two_title = e.options[e.selectedIndex].innerHTML;
			var e = document.getElementById("article_three");
			var article_three_title = e.options[e.selectedIndex].innerHTML;	
			
			<!--document.getElementById("demo").innerHTML = artOneOpt;-->
