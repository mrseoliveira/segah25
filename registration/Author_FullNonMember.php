...
$article_three = "";
$article_three_title = "";
$extra_one = "Author_FullNonMember";
$extra_two = "";
$extra_three = "";
$extra_four = "";
$extra_five = "";
...
function sendEmail($uniqueKey, $value,$url)
{
  ...
  $email_alt_body = "Dear $name, \n \n" .
					...
					"Registration Type: Author Full for Non-Member \n \n" .
 ...
 <html>
  ...
  <div class="row">
        <div class="col s12 m12 l8">
                  ...
                  <select name="str_article_two">
                    <option value="" disabled selected>Choose Article 2</option>
