...
$article_three = "";
$article_three_title = "";
$extra_one = "Attendee_RetiredMember";
$extra_two = "";
$extra_three = "";
$extra_four = "";
$extra_five = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if (empty($_POST["str_ieeenumber"]))
     $errorMessage = "10";
   else
     $ieee_number = test_input($_POST["str_ieeenumber"]);
   ...
   $article_three = test_input($_POST["str_article_three"]);
    ...
    $extra_five =   "S18" . round(10*microtime(true)) . "ARMB";
...
function sendEmail($uniqueKey, $value,$url)
{
  ...
  $email_alt_body = "Dear $name, \n \n" .
					...
					"Registration Type: IEEE Life Member \n \n" .
                              ...
                              <span class="card-title cinza-text"><h2>Registration Info</h2></span>
	                              ...
	                              <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
		                                 ...
		                                 <tbody>
		                                   ...
		                                   <tr>
		                                     <td>IEEE Number<span class="error"> * </td>
		                                     <td class="center">
		                                     	<input name="str_ieeenumber" type="text" class="validate" required>
		                                     </td>
		                                   </tr>
